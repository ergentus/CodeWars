...
function nbMonths(startPriceOld, startPriceNew, savingperMonth, percentLossByMonth) {
   let [months, stack] = [0, 0]
   let different = startPriceOld - startPriceNew

   while (different + stack < 0) {
      stack += savingperMonth
      months++
      ...
      different -= different / 100 * percentLossByMonth
   }

   return [months, Math.round(stack + different)]
}
